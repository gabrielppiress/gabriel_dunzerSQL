...
--
-- Banco de dados: `gabrieldunzerfinaceiro`
--
CREATE DATABASE IF NOT EXISTS `gabrieldunzerfinaceiro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `gabrieldunzerfinaceiro`;
